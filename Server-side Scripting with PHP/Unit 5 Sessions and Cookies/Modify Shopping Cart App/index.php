...
// set the session id to the variable $id and display it
$id = session_id();
echo 'Session ID:' , ' '.$id; // print the session id to the screen
...
switch($action) {
    ...
    case 'end_session_delete_cookie':
        ...
        $expire = strtotime('-1 year'); // create expiration date one year in past
